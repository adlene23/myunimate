    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          itemCount: universityInfoSections.length +
              4, // Additional inputs for images
          itemBuilder: (context, index) {
            if (index == universityInfoSections.length + 1) {
              ...
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                   Text('Additional Pictures',  style: Theme.of(context).textTheme.subtitle1!.copyWith(color: primaryColor),),
                  const SizedBox(height: 8),
                  GridView.builder(
