          ...
          children: [
                ...
                child: Stack(
                  ...
                  Positioned(
                      ...
                      child: Row(
                        ...
                        children: [
                          IconButton(
                            icon: const Icon(Unicons.sound, size: 20, color: primaryColor),
                            onPressed: () {},
                          ),
                          IconButton(
                              icon: const Icon(Unicons.image, size: 18, color: primaryColor),
                              onPressed: () async {
            ...
            Row(
              children: [
                ...
                Text("# Tags", style: Theme.of(context).textTheme.subtitle1!.copyWith(color: primaryColor)),
              ],
            ),
            ...
            Row(
              ...
              children: [
                Text("# University", style: Theme.of(context).textTheme.titleMedium!.copyWith(color: primaryColor),),
